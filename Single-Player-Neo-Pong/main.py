...
while True:
  ...
  screen.blit(largefont.render('Use w and s or up or down arrow keys', 1, (255,0,0)), (60, 160))
  if play == 1:
    screen.blit(largefont.render('Click anywhere to begin.', 1, (255,255,255)), (150, 195))
  else:
