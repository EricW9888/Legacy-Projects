...
def binary_to_string(ascii, starting, binaries, decimals, key):  
  temp = ""
  string = ""

  encoded = starting.strip()
  reverse = ""
...
def string_to_binary(ascii, starting, strings, decimals):
  temp = ""
  binary = ""
...
if type.lower() == "decode":
  key = int(input("key?"))
  binary_to_string(ascii, starting, binaries, decimals, key)
  
elif type.lower() == "encode":
  string_to_binary(ascii, starting, strings, decimals)