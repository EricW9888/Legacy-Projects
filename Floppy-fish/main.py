...
while True:
  ...
  screen.blit(messagefont.render('Fish.', 1, (0,0,0)), (270, 175))
  screen.blit(largefont.render('Use the arrow or S and W keys to move', 1, (0,0,0)), (65, 230))
  screen.blit(largefont.render('up and down', 1, (0,0,0)), (240, 260))
  if play == 1:
    screen.blit(largefont.render('Click anywhere to begin.', 1, (0,0,0)), (170, 300))
  else:
    screen.blit(largefont.render('Click anywhere or press any key to begin.', 1, (0,0,0)), (50, 350))
  fpsClock.tick(FPS)
